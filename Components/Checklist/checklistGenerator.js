        ...
        <div id="divCreateChecklist">
            <header>
                ...
                <div id="dayQuantits">
                    ...
                    <button type="button" class="dayQuantitsButton" id="clicked_31" data-function="uniqueClicked" data-link="dayQuantitsLabel" value="31" title="Lista de tarefas para o mês" style="background-color:#ffffff66"> M </button>
                </div> 
            </header>            
            <aside>
            ...
            <footer>
                <button type="button" data-function="cancelChecklist" class="buttonDefualt"> Cancelar </button>
